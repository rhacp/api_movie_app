...
Many thanks to "The Movie DB"! Their public API is used to fetch movies for the project:
...
3. Use the `Generate Token` request along the credentials mentioned above to get an API token (only an admin user can use the `Register` endpoint).
